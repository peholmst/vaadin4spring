...
import org.vaadin.spring.demo.web.filter.CachingHttpHeadersFilter;
import org.vaadin.spring.demo.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initCachingHttpHeadersFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        cachingHttpHeadersFilter.addMappingForUrlPatterns(disps, true, "/VAADIN/*");
    ...
    private void initMetrics(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        metricsAdminServlet.addMapping("/system/metrics/metrics/*");
